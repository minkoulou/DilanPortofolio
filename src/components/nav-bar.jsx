      ...
      <div>
        <section className="bg-primary w-full h-[5%] flex bar max-w-6xl mx-auto">
            ...
            <article className="w-[20%] flex items-center">
                <p className="font-bold text-sm lg:text-xl text-blue-100 font-heading ml-2 lg:ml-8 mt-2 mb-2">DILANE EVINA</p>
            </article>

            <nav className="hidden sm:w-[60%] sm:flex sm:justify-center items-center md:gap-8 lg:gap- sm:gap-8 md:w-[80%]">
            ...
            {isOpen &&  (<nav className="flex flex-col z-10 absolute right-1 rounded-bl-xl rounded-br-xl top-12 tel w-40 p-4 sm:hidden gap-4">
